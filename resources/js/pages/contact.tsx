...
export default function Contacto() {
  return (
    <div className="min-h-screen bg-white p-6 font-sans">
      {/* Título */}
      <h1 className="text-8xl font-bold text-green-800 mb-4 text-center">
        BuscaFarma
      </h1>

      {/* Descripción */}
      <p className="text-0.5g text-black-800 text-center mb-8 max-w-6xl mx-auto text-justify">
      ...
      <form className="max-w-xl mx-auto bg-gray-50 p-6 rounded-2xl shadow-md space-y-4">
        <div>
          ...
          <input type="text" className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-green-200" />
        </div>
        ...
        <div>
          ...
          <input type="email" className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-green-200" />
        </div>

        <div>
          <label className="block mb-1 text-green-800 font-medium">Número</label>
          <input type="number" className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-green-200" />
        </div>
