...
export default function search() {
  ...
  return (
    <div className="min-h-screen bg-white p-6 font-sans">
      {/* Título */}
      <h1 className="text-6xl font-bold text-green-700 mb-8 text-center">
        BuscaFarma
      </h1>
      ...
      <form onSubmit={manejarEnvio} className="max-w-xl mx-auto flex gap-4 mb-6">
        <input
          type="text"
          value={busqueda}
      ...
      <div className="max-w-xl mx-auto space-y-2">
        {historial.length > 0 && (
          <>
            <h2 className="text-green-800 text-xl font-semibold mb-2">Medicamentos a buscar:</h2>
        ...
        <div className= "flex justify-center mt-8">
            <Button className="bg-green-800 text-white text-1xl px-8 py-4 rounded-md hover:bg-green-700 transition-colors border-green-800 hover:bg-green-100 " variant="outline">
